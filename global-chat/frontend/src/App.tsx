...
function App() {
  ...
  if (!socket) {
    return (
      <div className="bg-[#0A0A0A] h-[100vh] flex items-center justify-center relative overflow-hidden">
  ...
  return (
    <div className='bg-[#0A0A0A] h-[100vh] flex flex-col font-mono relative overflow-hidden w-full max-w-full'>
